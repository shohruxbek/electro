...
if($_GET['search']){
	$cat_id  = mysqli_real_escape_string($connect, trim($_GET['cat']));
...
if($cat_id == 0){
	$product_sum_sql = "SELECT COUNT(id) FROM `product` WHERE `status`='1' and `name_uz` LIKE '%".$search."%'";
}else{
$product_sum_sql = "SELECT COUNT(id) FROM `product` WHERE `status`='1' and `category_id`='".$cat_id."' and `name_uz` LIKE '%".$search."%'";
}
...
if($cat_id == 0){
	$product_sql = "SELECT * FROM `product` WHERE `status`='1' and `name_uz` LIKE '%".$search."%' LIMIT ".$p.",".$limit;
}else{
	$product_sql = "SELECT * FROM `product` WHERE `status`='1' and `category_id`='".$cat_id."' and `name_uz` LIKE '%".$search."%' LIMIT ".$p.",".$limit;
}
